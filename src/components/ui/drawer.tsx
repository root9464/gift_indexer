...
type DrawerContentProps = Extend<React.ComponentProps<typeof DrawerPrimitive.Content>, { swipeable?: boolean }>;

function DrawerContent({ className, children, swipeable = true, ...props }: DrawerContentProps) {
  return (
